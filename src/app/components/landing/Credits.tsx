        ...
        <div className="text-center space-y-6 md:space-y-8">
          ...
          <div className="space-y-1.5 md:space-y-2">
            ...
            <p className="text-xs sm:text-sm md:text-base text-text-light/70 max-w-3xl mx-auto px-4 leading-relaxed">
              Innovatech Solution based in Puerto Princesa City, Palawan. Our
              platform is built with cutting-edge technologies to deliver fast,
              secure, and reliable user experiences.
            </p>
            ...
            <div className="group glass-card-dark rounded-lg md:rounded-xl p-4 sm:p-5 md:p-6 hover:bg-white/10 transition-all duration-300 border border-white/5 max-w-sm mx-auto sm:max-w-none w-full">
              <div className="flex flex-col items-center gap-2 md:gap-3">
                ...
                <div className="text-center space-y-0.5 md:space-y-1">
                  ...
                  <p className="text-xs text-text-light/60">React Framework</p>
                </div>
          ...
          {/* GitHub Repository Card with Crafted by */}
          <div className="glass-card-dark rounded-lg md:rounded-xl p-4 sm:p-5 md:p-6 max-w-5xl mx-auto border border-white/5 group hover:border-primary-blue/30 transition-all duration-300">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-blue to-primary-purple rounded-xl blur-xl opacity-0 group-hover:opacity-40 transition-opacity duration-300"></div>
                  <div className="relative bg-black rounded-lg md:rounded-xl p-3 md:p-4 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-xl border border-white/10">
                    <Github className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-text-light" />
                  </div>
                </div>
                <div className="text-center sm:text-left">
                  <h3 className="text-base sm:text-lg md:text-xl font-bold text-text-light mb-1">
                    Open Source Project
                  </h3>
                  <p className="text-xs sm:text-sm text-text-light/60">
              ...
              <a
                ...
                className="group/btn px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg bg-gradient-to-r from-primary-blue to-primary-purple text-white font-medium text-sm sm:text-base hover:shadow-lg hover:shadow-primary-blue/50 transition-all duration-300 flex items-center gap-2 hover:gap-3 w-full sm:w-auto justify-center"
              >
            ...
            <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-white/10">
              <p className="body-text text-text-light/80 flex items-center justify-center gap-1.5 flex-wrap text-xs sm:text-sm">
                <span>Crafted with</span>
                <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500 fill-red-500 animate-pulse flex-shrink-0" />
                <span>and</span>
                <Coffee className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-600 flex-shrink-0" />
                <span>by</span>
                <span className="bg-gradient-to-r from-primary-blue via-primary-purple to-sky-blue bg-clip-text text-transparent font-bold">
                  Innovatech Team
                </span>
              </p>
            </div>
